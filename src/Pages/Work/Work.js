                ...
                {selectedCard && (
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div layoutId={`card-content-${selectedCard.id}`} className="p-6">
                                <h2 className="text-2xl font-semibold mb-4">{selectedCard.title}</h2>
                                <div 
                                    className="text-gray-700"
                                    dangerouslySetInnerHTML={{ __html: selectedCard.prevDescription }}
                                />
