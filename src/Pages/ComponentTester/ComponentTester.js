  ...
  return (
    <Canvas camera={{ position: [0, 0, 15], fov: 50 }}>
      ...
      {projects.map((project, index) => (
        <ProjectCube
          key={index}
          position={[(index % 3) * 5 - 5, Math.floor(index / 3) * -5 + 2, 0]}
          color={project.color}
          project={project}
  ...
  const projects = [
    {
      ...
      description:
        "A full-stack e-commerce platform with product management, cart functionality, payment processing, and user authentication.",
      technologies: [
        "React",
        "Node.js",
        "Express",
    ...
    },
    {
      ...
      description:
        "A real-time messaging application with private and group chats, file sharing, and user presence indicators.",
    ...
    },
    {
      ...
      description:
        "A collaborative task management system with boards, lists, and cards. Features include deadlines, assignments, and integrations.",
    ...
    },
    {
      ...
      description:
        "A custom CMS built for content creators with rich text editing, media management, and publishing workflows.",
    ...
    },
    {
      ...
      description:
        "An interactive dashboard visualizing complex data with charts, filters, and customizable views.",
    ...
    },
    {
      ...
      description:
        "A social networking platform with profiles, posts, comments, and real-time notifications.",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="lg:w-1/2 p-6 bg-white dark:bg-gray-800 bg-opacity-90 dark:bg-opacity-90 rounded-lg shadow-xl">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-8">
                ...
                Specialized in creating seamless user experiences and robust
                backend systems.
              </p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                ...
                in building responsive, user-friendly applications that solve
                real-world problems. My expertise spans the entire development
                stack, from crafting intuitive frontends to designing scalable
                backend systems.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="bg-gray-200 dark:bg-gray-700 hover:bg-blue-100 dark:hover:bg-blue-900 p-3 rounded-full"
                  >
                    <svg
